...
public class TripSpendingController {
    ...
    @PostMapping
    public ApiResponse<TripSpending> create(@Valid @RequestBody TripSpendingRequest request) {
        return ApiResponse.success("Trip spending created successfully", tripSpendingService.create(request));
    }
